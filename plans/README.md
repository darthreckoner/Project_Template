...
| --- | --- | --- | --- | --- |
| PLAN-001 | Completed | Reduce Bootstrap Friction Through Progressive Profiles | None | d9b03e2 |

This source template currently contains one completed maintenance plan pending distributable-tree
cleanup. After cleanup, the plan and its index entry will be removed so a project created from it
begins with an empty plan lifecycle.
