...
tracker-specific.** Read `docs/agents/issue-tracker.md`, including its "Wayfinding operations"
section. If it is missing, stop and report that required repository configuration is absent.
